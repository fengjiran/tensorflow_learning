...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        ...
        for (img_path, mask_path) in zip(image_paths, mask_paths):
            ...
            imwrite(os.path.join(sample_dir, 'celebahq_edge_inpainted_%04d.png' % i), inpainted_edge)
            ...
            imwrite(os.path.join(sample_dir, 'celebahq_masked_%04d.png' % i), masked_img)
