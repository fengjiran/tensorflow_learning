...
model_path = 'E:\\comparative_models\\GLCIC\\celeba\\model_cn'
...
for dir1, dir2 in zip(img_dir, irregular_mask_dir):
    ...
    filename = os.path.join(irregular_output_path, 'irregular_output_%03d.png' % i)
...
for dir1, dir2 in zip(img_dir, regular_mask_dir):
    ...
    filename = os.path.join(regular_output_path, 'regular_output_%03d.png' % i)
