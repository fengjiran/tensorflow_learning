...
# Output dir
regular_output_dir = 'E:\\model\\experiments\\exp2\\celebahq\\results\\deepfillv1\\regular'
...
with tf.Session(config=sess_config) as sess:
    ...
    for dir1, dir2 in zip(img_list, regular_mask_list):
        ...
        imwrite(os.path.join(regular_output_dir, 'inpainted_%03d.png' % i), result[0][:, :, ::-1])
        i += 1
