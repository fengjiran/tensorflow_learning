...
celebahq_img_dir = 'E:\\model\\experiments\\exp3\\celebahq\\gt_images'
psv_img_dir = 'E:\\model\\experiments\\exp3\\psv\\gt_images'
...
# regular_celebahq_results_dir = 'E:\\model\\experiments\\exp3\\psv\\results\\FMM\\50'

# irregular_psv_results_dir = 'E:\\model\\experiments\\exp2\\psv\\results\\FMM\\irregular'
regular_psv_results_dir = 'E:\\model\\experiments\\exp3\\psv\\results\\FMM\\128'
...
#     imwrite(os.path.join(regular_celebahq_results_dir, 'celebahq_110_%04d.png' % i), dst)
...
for path1, path2 in zip(psv_flist, regular_mask_flist):
    ...
    mask = 255 - mask
    dst = cv2.inpaint(img, mask, 5, cv2.INPAINT_TELEA)
    imwrite(os.path.join(regular_psv_results_dir, 'psv_regular_result_%04d.png' % i), dst)
