...
def create_celebahq_tfrecord(tfrecord_dir, celebahq_dir):
    ...
    tfrecordname = os.path.join(tfrecord_dir, 'celebahq_trainset.tfrecord-%.3d' % num_tfrecords)
    writer = tf.python_io.TFRecordWriter(path=tfrecordname)
...
if __name__ == '__main__':
    ...
    tfrecord_dir = 'F:\\Datasets\\celebahq_tfrecords\\train'
