...
class Dataset():
    ...
    def load_images(self):
        ...
        # dataset = dataset.apply(tf.contrib.data.batch_and_drop_remainder(self.cfg['BATCH_SIZE']))
...
class MaskDataset():
    ...
    def load_masks(self):
        ...
        if self.mask_type == 2:
            ...
            # mask_dataset = mask_dataset.apply(tf.contrib.data.batch_and_drop_remainder(self.cfg['BATCH_SIZE']))
