...
if platform.system() == 'Windows':
    ...
    model_path = 'E:\\TensorFlow_Learning\\Inpainting\\MPGAN\\CelebA\\models_local_l1'
    ...
    model_path = '/home/richard/TensorFlow_Learning/Inpainting/MPGAN/CelebA/models_local_l1'
...
def train():
    ...
    var_d = tf.get_collection('local_dis_params_conv') + tf.get_collection('local_dis_params_bn')
    ...
    grads_vars_d = opt_d.compute_gradients(loss_local_dis, var_d)
