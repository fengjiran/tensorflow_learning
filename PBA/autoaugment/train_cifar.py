...
def setup_arg_scopes(is_training):
    """Set up the argscopes that will be used when building an image model.
...
def build_model(inputs, num_classes, is_training, hparams):
    """Construct the vision model being trained/evaled.
...
class CifarModel(object):
    """Build an image model for Cifar10/Cifar100."""
    ...
    def _setup_misc(self, mode):
        """Set up miscellaneous in the cifar model constructor."""
    ...
    def _setup_images_and_labels(self):
        """Set up image and label placeholders for the cifar model."""
    ...
    def _build_graph(self, images, labels, mode):
        """Construct the TF graph for the cifar model.
...
class CifarModelTrainer(object):
    """Train an instance of the CifarModel class."""
    ...
    def save_model(self, step=None):
        """Dump model into the backup_dir.
    ...
    def _new_session(self, m):
        """Create a new session for model m."""
    ...
    def _build_models(self):
        """Build the image models for train and eval."""
    ...
    def _calc_starting_epoch(self, m):
        """Calculate the starting epoch for model m based on global step."""
        hparams = self.hparams
    ...
    def _run_training_loop(self, m, curr_epoch):
        """Train the cifar model `m` for one epoch."""
    ...
    def run_model(self):
        """Train and evalutes the image model."""
        hparams = self.hparams
